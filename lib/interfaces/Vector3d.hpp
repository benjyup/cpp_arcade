...
namespace arcade {
    ...
    public:
        ...
        int32_t getX(void) const { return (this->_x); };

        int32_t getY(void) const { return (this->_y); };

        int32_t getZ(void) const { return (this->_z); };

        void setX(int32_t x) { this->_x = x; };

        void setY(int32_t y) { this->_y = y; };

        void setZ(int32_t z) { this->_z = z; };
